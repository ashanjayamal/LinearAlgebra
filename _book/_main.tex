...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-22}{}\label{prp:unnamed-chunk-22}A vector space has a unique additive identity.
\end{proposition}
...
\begin{proposition}
\protect\hypertarget{prp:unnamed-chunk-24}{}\label{prp:unnamed-chunk-24}Every element in a vector space has a unique additive inverse.
\end{proposition}
