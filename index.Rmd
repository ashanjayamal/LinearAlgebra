...
```{r echo=FALSE}
  knitr::include_graphics('fig/Chapter-1/fig1.png') 
```
...
```{r echo=FALSE}
  knitr::include_graphics('fig/Chapter-1/fig2.png') 
```
...
```{r echo=FALSE}
  knitr::include_graphics('fig/Chapter-1/fig3.png') 
```
...
```{r echo=FALSE,fig.cap='Elements of R2 can be thought of as points or as vectors.'}
  knitr::include_graphics('fig/Chapter-1/fig4.png') 
```
...
```{r echo=FALSE,fig.cap='A vector'}
  knitr::include_graphics('fig/Chapter-1/fig5.png') 
```
...
#```{r echo=FALSE,fig.cap='The sum of two vectors. ' , fig.align = #'center'}
#  knitr::include_graphics('fig/Chapter-1/fig6.gif') 
#```
...
#```{r echo=FALSE,fig.cap='A vector and its additive inverse.' , #fig.align = 'center'}
#  knitr::include_graphics('fig/Chapter-1/fig7.gif') 
#```
